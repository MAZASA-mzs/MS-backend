...
def read_commands(
    platform: str = Query(None, description="Фильтр платформы: TG или MAX"),
...
def read_privacy_policy():
    ...
    """
    return {
        "text": "Официальный текст Политики Конфиденциальности и обработки ПД. "
        "Настоящим документом устанавливается...",
